...
const CATEGORY_COLORS = {
  'Structural Evolution':  { bg: 'rgba(96,165,250,0.12)', text: '#60a5fa', border: 'rgba(96,165,250,0.2)' },
  'Luxury Fit-Out':        { bg: 'rgba(212,175,55,0.12)',  text: '#D4AF37', border: 'rgba(212,175,55,0.2)' },
  'Architecture & MEP':    { bg: 'rgba(52,211,153,0.12)',  text: '#34d399', border: 'rgba(52,211,153,0.2)' },
  'Building Construction': { bg: 'rgba(96,165,250,0.12)',  text: '#60a5fa', border: 'rgba(96,165,250,0.2)' },
  'Interior Fit Outs':     { bg: 'rgba(212,175,55,0.12)',  text: '#D4AF37', border: 'rgba(212,175,55,0.2)' },
  'MEP Execution':         { bg: 'rgba(52,211,153,0.12)',  text: '#34d399', border: 'rgba(52,211,153,0.2)' },
  'Project Management':    { bg: 'rgba(196,27,31,0.12)',   text: '#f87171', border: 'rgba(196,27,31,0.2)' },
};

const CATEGORIES_ALL = ['All', ...Object.keys(CATEGORY_COLORS)];

function CategoryBadge({ category }) {
  const c = CATEGORY_COLORS[category] || { bg: 'rgba(255,255,255,0.08)', text: 'rgba(255,255,255,0.5)', border: 'rgba(255,255,255,0.1)' };
  return (
    <span
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-4">
        ...
        <Link
          ...
          style={{
            ...
            boxShadow: '0 4px 16px rgba(196,27,31,0.3)',
          }}
        >
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        >
          ...
          <select
            ...
            style={{ color: categoryFilter === 'All' ? 'rgba(255,255,255,0.5)' : '#fff' }}
          >
            {CATEGORIES_ALL.map(c => (
              <option key={c} style={{ background: '#061b36' }}>{c}</option>
            ))}
          </select>
        </div>
      </div>
      ...
      {loading ? (
        <div className="flex items-center justify-center h-56">
          <div className="text-center space-y-3">
            ...
            <p className="text-sm" style={{ color: 'rgba(255,255,255,0.4)' }}>Loading projects...</p>
          </div>
        </div>
      ) : filtered.length === 0 ? (
        <div
          className="text-center py-20 rounded-2xl"
          style={{ background: 'rgba(10,38,71,0.2)', border: '1px dashed rgba(255,255,255,0.08)' }}
        >
          <FolderOpen className="w-12 h-12 mx-auto mb-4" style={{ color: 'rgba(255,255,255,0.15)' }} />
              ...
              <div className="relative aspect-video overflow-hidden" style={{ background: 'rgba(255,255,255,0.05)' }}>
                ...
                {p.featured && (
                  <div
                    ...
                    style={{ background: 'rgba(212,175,55,0.9)', backdropFilter: 'blur(4px)' }}
                  >
                ...
                >
                  ...
                  <button
                    ...
                    style={{ background: 'rgba(255,255,255,0.15)', color: '#f87171' }}
                  >
              ...
              <div className="p-4 space-y-3">
                <div>
                  <div className="flex items-start justify-between gap-2 mb-1.5">
                    <h3 className="text-sm font-bold text-white leading-snug line-clamp-2 flex-1">{p.title}</h3>
                  </div>
                ...
                >
                  <div className="flex items-center gap-3 text-xs" style={{ color: 'rgba(255,255,255,0.35)' }}>
                    ...
                    <span style={{ color: 'rgba(255,255,255,0.25)' }}>{p.client}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <button
                      ...
                      className="w-7 h-7 rounded-lg flex items-center justify-center transition-colors"
                      style={{ background: 'rgba(255,255,255,0.06)', color: 'rgba(255,255,255,0.5)' }}
                      onMouseEnter={e => { e.currentTarget.style.background = 'rgba(196,27,31,0.15)'; e.currentTarget.style.color = '#f87171'; }}
                      onMouseLeave={e => { e.currentTarget.style.background = 'rgba(255,255,255,0.06)'; e.currentTarget.style.color = 'rgba(255,255,255,0.5)'; }}
                    >
