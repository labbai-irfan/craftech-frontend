...
export default function HomeCMS() {
  ...
  return (
    <div className="max-w-4xl space-y-6">
      <div>
        <h2 className="text-xl font-bold text-white">Home Page CMS</h2>
        <p className="text-sm text-slate-400">Manage the hero section, statistics, and section visibility/order.</p>
      </div>

      {/* Section Visibility & Order */}
      <div className="bg-slate-800/30 border border-slate-700/50 rounded-xl p-6">
        <h3 className="text-sm font-semibold text-white uppercase tracking-wider mb-4">Homepage Section Order</h3>
        <div className="space-y-2 max-h-64 overflow-y-auto">
          {(data?.sectionOrder || []).map((section, idx) => (
            <div key={section.sectionName} className="flex items-center gap-3 p-3 bg-slate-900/50 rounded-lg">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  disabled={idx === 0}
                  className="px-2 py-1 bg-slate-700 text-slate-300 text-xs rounded disabled:opacity-30 hover:bg-slate-600"
                >
                  ↑
                </button>
                <button
      ...
      <form onSubmit={handleSubmit} className="bg-slate-800/30 border border-slate-700/50 rounded-xl p-6 space-y-6">
        <div className="pt-6 border-b border-slate-700/50 pb-6 mb-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-semibold text-white uppercase tracking-wider">Hero Slides</h3>
            <button
              type="button"
              onClick={() => setData(prev => ({ ...prev, heroSlides: [...(prev.heroSlides || []), { image: '', title: '', subtitle: '', pos: 'center center' }] }))}
          ...
          <div className="space-y-4">
            {(data?.heroSlides || []).map((slide, i) => (
              <div key={i} className="bg-slate-800/50 border border-slate-700 rounded-xl p-4 space-y-3 relative">
                <button
                  type="button"
                  onClick={() => setData(prev => ({ ...prev, heroSlides: prev.heroSlides.filter((_, idx) => idx !== i) }))}
                  className="absolute top-2 right-2 p-1.5 text-slate-500 hover:text-red-400"
                >
                  <Trash2 className="w-4 h-4" />
                </button>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="md:col-span-2">
                    <label className="block text-[10px] font-bold text-slate-500 uppercase mb-1">Slide Title (Use comma for accent color)</label>
                    <input
                      type="text"
                  ...
                  <div className="md:col-span-2">
                    <label className="block text-[10px] font-bold text-slate-500 uppercase mb-1">Slide Subtitle</label>
                    <input
                      type="text"
                      className="w-full px-3 py-2 bg-slate-900 border border-slate-700 rounded-lg text-white text-sm"
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-slate-500 uppercase mb-1">Image Position (e.g. center center)</label>
                    <input
                      type="text"
                      className="w-full px-3 py-2 bg-slate-900 border border-slate-700 rounded-lg text-white text-sm"
                      value={slide.pos}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 opacity-50 grayscale pointer-events-none">
          <div className="md:col-span-2">
            <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Hero Title</label>
            <input
              type="text"
              required
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">CTA Text</label>
            <input
              type="text"
              className="w-full px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white"
              value={data?.ctaText || ''}
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">CTA Link</label>
            <input
              type="text"
              className="w-full px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white"
              value={data?.ctaLink || ''}
        ...
        <div className="pt-6 border-t border-slate-700/50">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-semibold text-white uppercase tracking-wider">Statistics</h3>
            <button
              type="button"
              onClick={addStat}
              className="text-xs flex items-center gap-1 text-blue-400 hover:text-blue-300"
            ...
            {(data?.stats || []).map((stat, i) => (
              <div key={i} className="flex items-center gap-3">
                <input
                  ...
                  className="w-1/3 px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white"
                  value={stat.value}
        ...
        <div className="pt-6 border-t border-slate-700/50">
          <h3 className="text-sm font-semibold text-white uppercase tracking-wider mb-4">About Section</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="md:col-span-2">
              <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">About Title</label>
              <input
                type="text"
                className="w-full px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white"
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">About Quote Author</label>
              <input
                type="text"
                className="w-full px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white"
            ...
            <div className="md:col-span-2">
              <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">About Quote</label>
              <textarea
                rows={2}
                className="w-full px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white"
        ...
        <div className="pt-6 border-t border-slate-700/50">
          <h3 className="text-sm font-semibold text-white uppercase tracking-wider mb-4">SEO Settings</h3>
          <div className="grid grid-cols-1 gap-5">
            <div>
              <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Meta Title</label>
              <input
                type="text"
                className="w-full px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white"
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Meta Description</label>
              <textarea
                rows={2}
                className="w-full px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white"
