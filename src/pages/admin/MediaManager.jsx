    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center space-y-3">
          ...
          <p className="text-sm" style={{ color: 'rgba(255,255,255,0.4)' }}>Loading media library...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
          ...
          >
            <button
              ...
              style={{
                ...
                color: gridView ? '#C41B1F' : 'rgba(255,255,255,0.4)',
              }}
            >
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          { icon: FolderOpen, label: 'Projects', value: projects.length, color: '#60a5fa' },
          { icon: ImageIcon, label: 'Images', value: totalImages, color: '#34d399' },
          { icon: Video, label: 'Videos', value: totalVideos, color: '#a78bfa' },
        ].map((item, i) => (
          <div
            key={i}
            className="flex items-center gap-3 px-4 py-3 rounded-2xl"
            style={{ background: 'rgba(10,38,71,0.25)', border: '1px solid rgba(255,255,255,0.07)' }}
          >
            <div
            ...
            <div>
              ...
              <p className="text-xs mt-0.5" style={{ color: 'rgba(255,255,255,0.35)' }}>{item.label}</p>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="space-y-3">
        {filtered.length === 0 && (
          <div
            ...
            style={{ background: 'rgba(10,38,71,0.15)', border: '1px solid rgba(255,255,255,0.06)' }}
          >
            <FolderOpen className="w-10 h-10 mx-auto mb-3" style={{ color: 'rgba(255,255,255,0.2)' }} />
            <p className="text-sm" style={{ color: 'rgba(255,255,255,0.4)' }}>No projects match "{search}"</p>
          </div>
        )}
          ...
          return (
            <div
              ...
              style={{
                ...
                border: `1px solid ${isOpen ? 'rgba(196,27,31,0.2)' : 'rgba(255,255,255,0.07)'}`,
              ...
              >
                ...
                >
                  {project.thumbnail
                    ...
                    : <FolderOpen className="w-5 h-5 m-3.5" style={{ color: 'rgba(255,255,255,0.3)' }} />
                  }
                </div>
                ...
                <div
                  ...
                  style={{
                    background: isOpen ? 'rgba(196,27,31,0.15)' : 'rgba(255,255,255,0.05)',
                    color: isOpen ? '#C41B1F' : 'rgba(255,255,255,0.4)',
                  }}
                >
              ...
              {isOpen && (
                ...
                >
                  ...
                  {imgCount > 0 && (
                    <div>
                      <div className="flex items-center gap-2 mb-3">
                        <ImageIcon className="w-3.5 h-3.5" style={{ color: '#34d399' }} />
                          ...
                          {project.images.map((url, i) => (
                            ...
                            >
                              <img
                                ...
                                style={{ background: 'rgba(255,255,255,0.05)' }}
                              />
                              <p className="flex-1 text-xs text-white truncate">{url.split('/').pop()}</p>
                              <a
                                href={url}
                                target="_blank"
                                rel="noreferrer"
                  ...
                  {imgCount === 0 && (
                    ...
                    >
                      <ImageIcon className="w-6 h-6 mx-auto mb-2" style={{ color: 'rgba(255,255,255,0.15)' }} />
                      <p className="text-xs" style={{ color: 'rgba(255,255,255,0.3)' }}>No images uploaded</p>
                    </div>
                  )}
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {project.videos.map((v, i) => (
                          ...
                          >
                            ...
                            >
                              <Video className="w-3.5 h-3.5 flex-shrink-0" style={{ color: '#a78bfa' }} />
                              <p className="text-xs font-medium text-white truncate flex-1">{v.label}</p>
                              <a
                                href={v.url}
                                target="_blank"
                                rel="noreferrer"
