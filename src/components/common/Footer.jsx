    ...
    <footer className="bg-white pt-24 pb-12 border-t border-gray-100">
      <div className="container mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-4">
              {[
                ...
                { icon: 'fa-whatsapp', link: 'https://wa.me/919702873497' },
              ].map((s, i) => (
                <a key={i} href={s.link} className="w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center text-blue hover:bg-blue hover:text-white hover:border-blue transition-all duration-300">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {quickLinks.map((l, i) => (
                <li key={i}>
                  <a href={l.href} className="text-sm font-medium text-mid hover:text-blue hover:pl-2 transition-all flex items-center gap-2">
          ...
          <div>
            ...
            <ul className="space-y-5">
              <li className="flex items-start gap-4">
                ...
                <a href="tel:+919324877493" className="text-sm font-black text-mid hover:text-blue transition-colors">+91 93248 77493</a>
              </li>
              <li className="flex items-start gap-4">
                <i className="fa-solid fa-envelope text-blue mt-1" />
                <a href="mailto:info@craftechengineers.com" className="text-sm font-black text-mid hover:text-blue transition-colors">info@craftechengineers.com</a>
              </li>
              <li className="flex items-start gap-4">
        ...
        <div className="pt-12 border-t border-gray-50 flex flex-col md:flex-row items-center justify-between gap-6 text-[0.8rem] font-bold text-mid uppercase tracking-[1px]">
          <p>© 2026 <span className="text-blue">Craftech Engineers Pvt. Ltd.</span> All rights reserved.</p>
          <p>Built with <span className="text-accent">♥</span> for excellence in construction.</p>
        </div>
      </div>
    </footer>
  );
